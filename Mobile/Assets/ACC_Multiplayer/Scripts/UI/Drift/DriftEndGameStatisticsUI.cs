...
public class DriftEndGameStatisticsUI : MonoBehaviour
{
    ...
    IEnumerator ShowEndGameCoroutine()
    {
        ...
        {
            // 1. Parayı buluta gönder
            PlayfabManager.instance.AddMoneyToCloud(money);

            // 2. Skoru Leaderboard'a gönder
            PlayfabManager.instance.SendLeaderboard(Mathf.RoundToInt(PlayerStatistics.TotalScore));
        }
